 ...
 *
 * Skipped semantics:
 *  - bulkGrant: user already has an active token (avoid duplicate ConflictErrors).
 ...
 *  - `skippedReasons` — a map of userId → reason string ('already_has_token') 
 *    for users that were skipped in bulkGrant.
 */
